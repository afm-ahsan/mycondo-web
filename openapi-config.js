...
// `curl http://localhost:5000/openapi/v1.json -o openapi/mycondo-api.json` against a running backend,
// then `npm run codegen:api`). Injects into the shared baseApi (src/api/baseApi.ts) — see ADR-005.

      ...
      if (!registrationId) {
        const created = await createRegistration({
          createOccupancyRegistrationCommand: {
            ...
            primaryGender: null,
            primaryBloodGroup: null,
            primaryReligion: null,
            primaryNationality: null,
            primaryFatherName: null,
            primaryMotherName: null,
            primaryMaritalStatus: null,
        ...
        await updateDraft({
          ...
          updateOccupancyRegistrationDraftRequest: {
            ...
            primaryGender: existingRegistration?.primaryGender ?? null,
            primaryBloodGroup: existingRegistration?.primaryBloodGroup ?? null,
            primaryReligion: existingRegistration?.primaryReligion ?? null,
            primaryNationality: existingRegistration?.primaryNationality ?? null,
            primaryFatherName: existingRegistration?.primaryFatherName ?? null,
            primaryMotherName: existingRegistration?.primaryMotherName ?? null,
            primaryMaritalStatus: existingRegistration?.primaryMaritalStatus ?? null,
            primaryProfession: existingRegistration?.primaryProfession ?? null,

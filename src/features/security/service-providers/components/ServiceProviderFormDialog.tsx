...
// profile itself.
export function ServiceProviderFormDialog({ open, onOpenChange }: ServiceProviderFormDialogProps) {
  ...
  return (
    <EntityFormDialog open={open} onOpenChange={onOpenChange} title="Register Provider">
      <Form {...form}>

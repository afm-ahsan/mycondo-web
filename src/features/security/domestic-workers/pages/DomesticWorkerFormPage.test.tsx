...
import { DomesticWorkerFormPage } from './DomesticWorkerFormPage';
...
describe('DomesticWorkerFormPage', () => {
  it('maps a backend validation error onto the matching form field', async () => {
    ...
    renderWithProviders(<DomesticWorkerFormPage />, { auth: { user: guardUser, isInitialized: true } });

...
import { Ban, Car, LogIn, Plus, ShieldCheck } from 'lucide-react';
...
export function VehicleDirectoryPage() {
  ...
  const columns: ColumnDef<VehicleDto>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <RowActionsMenu
          ariaLabel={`Actions for ${row.original.registrationNumber}`}
          actions={[
            {
              key: 'unblock',
              label: 'Unblock',
              ...
              permission: PERMISSIONS.vehicle.blockManage,

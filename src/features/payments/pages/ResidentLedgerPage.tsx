...
import {
  ...
  ledgerReferenceTypeLabel,
} from '../lib/ledgerReferenceType';
  ...
  return (
    <>
      <PageHeader
        ...
        crumbs={[{ label: 'Finance' }, { label: 'Resident Ledger' }]}
      />
            ...
            {filters.flatId && (
              <div className="flex items-center justify-between rounded-md border border-border p-3">
                <span className="text-sm text-muted-foreground">
                  Current balance (authoritative, server-computed)
                </span>
                {isBalanceFetching ? (
              ...
              <Card>
                <CardHeader className="flex-wrap gap-3">
                  ...
                  <div className="flex flex-wrap items-end gap-3">
                    <div className="space-y-1.5">
                      <Label htmlFor="ledger-from-date" className="text-xs">
                        From
                      </Label>
                      <Input
                        id="ledger-from-date"
                        ...
                        onChange={(e) =>
                          setFilters({ fromDate: e.target.value, page: '1' })
                        }
                      />
                    </div>
                    <div className="space-y-1.5">
                      <Label htmlFor="ledger-to-date" className="text-xs">
                        To
                      </Label>
                      <Input
                        id="ledger-to-date"
                        ...
                        onChange={(e) =>
                          setFilters({ toDate: e.target.value, page: '1' })
                        }
                      />
                    </div>
                    <div className="space-y-1.5">
